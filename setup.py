...
def get_version():
    """ Gets version from rss.__init__.py

    Runs `rss.__init__` and loads defined variables into scope
    """
    with open(os.path.join('rss', '__init__.py')) as version_file:
...
setup(
    ...
    version=get_version(),
    url="https://gitee.com/lizhemin15/rss",
    download_url='https://gitee.com/lizhemin15/rss',
